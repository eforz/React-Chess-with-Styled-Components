...
import { Figure } from './figures/ClassFigure';

export class Board {
    // The cells themselves are a two-dimensional array, these are rows and columns
    // A row is a one-dimensional array, columns are a two-dimensional array. Matrix
    cells: Cell[][] = [];
